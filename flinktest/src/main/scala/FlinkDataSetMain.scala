...
object FlinkDataSetMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /*CoGroup*/
    val textCogroup1 = env.fromElements(("11", 2,2), ("12",1, 5), ("13",5, 1), ("14",3, 2))
    val textCogroup2 = env.fromElements(("21", 2,2), ("22",1, 5), ("23",5, 1), ("24",3, 2))
    ...
    val textCross1 = env.fromElements(("11", 2,2), ("12",1, 5), ("13",5, 1), ("14",3, 2))
    val textCross2 = env.fromElements(("21", 2,2), ("22",1, 5), ("23",5, 1), ("24",3, 2))
   /* crossWithTiny
    crossWithHuge*/
    ...
    textJoin1.rightOuterJoin(textJoin2).where(1).equalTo(0) {
      (p1,p2) =>({if (p1==null) "" else p1._1} + p2._3, if(p1==null) 0 else p1._2 +  p2._1)
    } .print()
...
(1ssss,4)*/
    textJoin1.leftOuterJoin(textJoin2).where(1).equalTo(0) {
      (p1,p2) => (p1._1 + {if (p2 == null)  "" else p2._3}, p1._2 +  {if (p2 == null)  0 else p2._1})
    } .print()
